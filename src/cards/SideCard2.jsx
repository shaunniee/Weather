      ...
      <div className={styles.grid2}>
        <div className={styles.item2}>
          ...
          <div className={styles.item2_data}>
            ...
            <span className={styles.item2_data_value}>
        ...
        <div className={styles.item2}>
          ...
          <div className={styles.item2_data}>
            ...
            <span className={styles.item2_data_value}>
              {data && data.current && data.current.precip_mm} mm
            </span>
          </div>
        </div>
        <div className={styles.item2}>
          ...
          <div className={styles.item2_data}>
            <span className={styles.item2_data_title}>UV Index</span>
            <span className={styles.item2_data_value}>
              {data && data.current && data.current.uv}
            </span>
          </div>
        </div>
        <div className={styles.item2}>
          ...
          <div className={styles.item2_data}>
            <span className={styles.item2_data_title}>Humidity</span>
            <span className={styles.item2_data_value}>
